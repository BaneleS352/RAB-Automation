...
- **Demo Lab**: `/demo/flow` creates a live Jira ticket and runs a full SDL → SDM → meeting workflow, producing real logs and audit records
...
rab-automation/
  app/
    ...
    services/
      ...
      dummy_flow.py            # Live Jira-backed Demo Lab scenarios
